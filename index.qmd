...
author:
  - name: Héctor Hernández-Alonso
    orcid: 0000-0001-7840-4230
    corresponding: true
    email: hector.hernandez@cefe.cnrs.fr
    roles: [define, all, roles]
    affiliation:
      - id: CNRS
        name: CEFE (CNRS)
      - id: iuFOR
        name: iuFOR
  - name: Bastian Laforgue
    corresponding: false
    roles: [define, all, roles]
    affiliation:
      - ref: CNRS
  - name: Camille Marande
    corresponding: false
    roles: [define, all, roles]
    affiliation:
      - ref: CNRS
  - name: Lùla Marcet
    ...
    affiliation:
      - ref: CNRS
  - name: Jean-Marc Ourcival
    corresponding: false
    roles: [define, all, roles]
    affiliation:
      - ref: CNRS
  - name: Xavier Morin
    orcid: 0000-0003-1961-8700
    corresponding: false
    roles: [define, all, roles]
...
# Material and Methods for poster communication *TSB4_P6* {style="text-align: justify"}
